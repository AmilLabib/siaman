...
export default function BottomNav() {
  ...
  const items = currentUser?.role === 'warga' ? wargaItems : satpamItems

  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white border-t border-blue-100 z-40 safe-area-bottom">
